 ...
 */
export declare function isUnauthorizedError(error: UnauthorizedError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a forbidden
 * request error
 */
export declare function isForbiddenError(error: ForbiddenError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents an invalid
 * request error
 */
export declare function isInvalidError(error: InvalidError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a bad request
 * error
 */
export declare function isBadRequestError(error: BadRequestError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a "not found"
 * error
 */
export declare function isNotFoundError(error: NotFoundError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a "gone"
 * error
 */
export declare function isGoneError(error: GoneError | number): boolean;
/**
 ...
 * "abort" error
 */
export declare function isAbortError(error: AbortError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a
 * conflict error
 */
export declare function isConflictError(error: ConflictError | number): boolean;
/**
 * Checks if the given status code or AjaxError object represents a server error
 */
export declare function isServerError(error: ServerError | number): boolean;
/**
